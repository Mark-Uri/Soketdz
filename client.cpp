...
{
    cout << "\n===== МЕНЮ ====="<<endl;
    cout << "1. Присоединиться к общей комнате"<<endl;
    cout << "2. Войти в приватную комнату"<<endl;
    cout << "3. Написать личное сообщение"<<endl;
    cout << "4. Посмотреть историю"<<endl;
    cout << "5. Выйти"<<endl;
    if (isAdmin) 
    {
        cout << "6. Удалить пользователя"<<endl;
        cout << "7. Забанить пользователя"<<endl;
        cout << "8. Просмотр логов с цензурой"<<endl;
    }
